...
@section('content')
      ...
      <form action="{{url('store')}}" class="creatform" method="POST">
        @csrf
        <div class="body" style="margin-top: 20px">
          <div class="form-group form-row">
              <label class="col-lg-12 control-label" name="name">Item Name <span class="text-danger">*</span></label>
              <div class="col-lg-12">
                <input type="text" class="form-control" placeholder="item name" name="item">
              </div>
          </div>
          <div class="form-group form-row">
            <label class="col-lg-12 control-label" name="amount">Amount <span class="text-danger">*</span></label>
            <div class="col-lg-6">
